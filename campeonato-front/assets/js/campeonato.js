  ...
  modalOverlay.querySelector(".modal-content").innerHTML = `
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p>Valor a pagar: <span class="badge bg-light text-dark">${
              item.valor_pagar
            } KZ</span></p>
  ...
  const formTamplete = `
    ...
    <form  id="registrationForm" class="row g-2 needs-validation" novalidate onsubmit="handleValidation(event)">
        ...
        <div class="col-md-6">
            ...
            <input type="number" class="form-control" id="valor_pagar" name="valor_pagar" value="${
              item?.valor_pagar ?? ""
            }" required step="0.01">
