        ...
        ({ id_tecnico, nome, experiencia, tipo, data_nascimento, sexo }, i) => {
            ...
            <tr data-key="${id_tecnico}">
                ...
                <td class='d-flex gap-2'>
                    ...
                    <button class="btn btn-primary btn-sm" onclick="handleBuildModalForm(${Number(id_tecnico)})">Editar</button>
...
async function handleDetails(id) {
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p>Experiência: <span class="badge bg-light text-dark">${item.experiencia ?? 0} anos</span></p>
...
async function handleBuildModalForm(id) {
    ...
    <form  id="registrationForm" class="row g-2 needs-validation" novalidate onsubmit="handleValidation(event)">
        ...
        <div class="col-md-6">
            ...
            <input type="number" class="form-control" id="experiencia" name="experiencia" value="${item?.experiencia ?? ''}" required>
