  ...
  modalOverlay.querySelector(".modal-content").innerHTML = `
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p>Número: <span class="badge bg-light text-dark">${item.numero
    }</span></p>
  ...
  const formTamplete = `
    ...
    <form  id="registrationForm" class="row g-2 needs-validation" novalidate onsubmit="handleValidation(event)">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="posicao" name="posicao" value="${item?.posicao ?? ""
    }" required>
        ...
        <div class="col-md-6">
            ...
            <input type="number" class="form-control" id="numero" name="numero" value="${item?.numero ?? ""
    }" required>
