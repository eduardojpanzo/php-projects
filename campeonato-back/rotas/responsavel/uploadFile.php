...
if (isset($_FILES["foto"]) && isset($_POST["id_entidade"])) {
    $uploadDir = "uploads/responsavel/"; // Diretório para salvar as fotos
        ...
        if (file_exists($uploadFile)) {
            ...
            if ($_FILES["foto"]["size"] > 5000000) { // 5MB
                ...
                try {
                    ...
                    // Atualiza o ID da foto para o endidate correspondente
                    $sqlUpdate = "UPDATE responsavel SET id_foto={$idFoto} WHERE id_responsavel=${entidadeId}";
